...
impl Default for Dispatcher {
    ...
    fn default() -> Self {
        ...
        dispatcher.add_builtin("previous-directory", vec!["ret", "back", "b", "prev", "pd"], builtins::previous_directory);
        dispatcher.add_builtin("next-directory", vec!["adv", "forward", "f", "next", "nd"], builtins::next_directory);
        dispatcher.add_builtin("clear-terminal", vec!["clear", "cls"], builtins::clear_terminal);
        dispatcher.add_builtin("make-file", vec!["make", "touch", "new", "mf"], builtins::make_file);
